...
/*
  console.log(haeunInfo.favMovies[1]);
  console.log(haeunInfo.favFood[0].fatty);
  */
haeunInfo.favFood.forEach(function(favFood) {
  console.log(favFood.name);
});
